...
hl.bind("SUPER + ALT + COMMA", hl.dsp.exec_cmd("swaync-client --close-latest -sw"), { description = "Dismiss most recent notification" })

hl.bind("SUPER + CTRL + COMMA", hl.dsp.exec_cmd("swaync-client --close-all -sw"), { description = "Dismiss all notifications" })

hl.bind("SUPER + SHIFT + COMMA", hl.dsp.exec_cmd("swaync-client -d -sw"), { description = "Toggle do-not-disturb mode" })


-- Captures

hl.bind("SUPER + S", hl.dsp.exec_cmd([[hyprshot -z -m region --clipboard-only --silent && swayosd-client --custom-message "Screenshot copied to clipboard" --custom-icon "edit-copy"]]), { description = "Screenshot to clipboard without editing" })

hl.bind("SUPER + CTRL + S", hl.dsp.exec_cmd("hyprshot -z -m region --raw --silent | satty --filename -"), { description = "Screenshot with editing" })

hl.bind("SUPER + R", hl.dsp.exec_cmd("screen-record"), { description = "Toggle screen recording" })

hl.bind("SUPER + CTRL + C", hl.dsp.exec_cmd([[pkill hyprpicker || hyprpicker -a -f hex && swayosd-client --custom-message "Color copied to clipboard" --custom-icon "edit-copy"]]), { description = "Color picker" })
...
hl.bind("SUPER + CTRL + B", hl.dsp.exec_cmd(terminal .. " --class=floating.Bluetui -e bluetui"), { description = "Bluetooth controls" })

hl.bind("SUPER + CTRL + W", hl.dsp.exec_cmd(terminal .. " --class=floating.Gazelle -e gazelle"), { description = "Wifi controls" })

hl.bind("SUPER + CTRL + T", hl.dsp.exec_cmd(terminal .. " --class=floating.Btop -e btop"), { description = "Activity monitor" })


-- Package Management

hl.bind("SUPER + CTRL + I", hl.dsp.exec_cmd(terminal .. " --class=floating.Pacman -e pi"), { description = "Install packages" })

hl.bind("SUPER + CTRL + R", hl.dsp.exec_cmd(terminal .. " --class=floating.Pacman -e pr"), { description = "Remove Installed packages" })

hl.bind("SUPER + CTRL + U", hl.dsp.exec_cmd(terminal .. " --class=floating.Pacman -e piu"), { description = "Full system update" })
